...
:Original: http://docutils.sourceforge.net/docs/user/rst/quickstart.txt
...
.. _master quick reference:
   http://docutils.sourceforge.net/docs/user/rst/http://docutils.sourceforge.net/docs/user/rst/quickref.html
...
For example::
  ...
  .. image:: /_static/images/biohazard.png

results in:

.. image:: /_static/images/biohazard.png

The ``/_static/images/biohazard.png`` part indicates the filename of the image
